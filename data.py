    ...
    "Medicine": {
        "careers": {
            "Health Informatics Specialist": {
                ...
                "where_to_work": ["Hospitals", "Ministry of Health digital health projects", "Health NGOs", "Medical insurance providers"],
            ...
            "Biomedical Equipment Technician": {
                ...
                "where_to_work": ["Hospitals", "Private clinics", "Diagnostic laboratories", "Medical equipment suppliers"],
                "avg_monthly_salary_bwp": "6,000 - 14,000",
            },
            "Telemedicine Systems Coordinator": {
                ...
                "where_to_work": ["Hospitals", "Private telehealth providers", "NGOs", "District health programs"],
                "avg_monthly_salary_bwp": "7,000 - 15,000",
            },
        },
    },
    "Agriculture": {
        "careers": {
            "Precision Agriculture Technician": {
                ...
                "where_to_work": ["Commercial farms", "Agricultural research projects", "Agri-tech startups", "Government agriculture programs"],
                "avg_monthly_salary_bwp": "6,000 - 14,000",
            },
            "Agricultural Data Analyst": {
                ...
                "where_to_work": ["Agribusiness companies", "Research institutions", "Government departments", "Food supply companies"],
            ...
            "GIS and Remote Sensing Specialist": {
                ...
                "where_to_work": ["Ministry of Agriculture", "Environmental consultancies", "Research institutions", "Large farms", "NGOs"],
                "avg_monthly_salary_bwp": "7,500 - 17,000",
            },
        },
    },
    "Business": {
        "careers": {
            "Business Intelligence Analyst": {
                ...
                "where_to_work": ["Banks", "Retail companies", "Telecom companies", "Insurance companies", "Consulting firms"],
                "avg_monthly_salary_bwp": "8,000 - 18,000",
            },
            "FinTech Product Analyst": {
                ...
                "where_to_work": ["Banks", "Payment service providers", "Mobile money platforms", "Financial startups"],
            ...
            "ERP Systems Specialist": {
                ...
                "where_to_work": ["Large companies", "Manufacturing businesses", "Retail groups", "Consulting firms", "Government departments"],
                "avg_monthly_salary_bwp": "8,500 - 19,000",
            },
        },
    },
}
